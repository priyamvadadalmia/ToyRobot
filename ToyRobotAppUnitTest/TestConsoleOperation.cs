...
{
    [TestFixture]
   public class TestConsoleOperation
    {
        /// <summary>
        ...
        {
            // arrange
            var paramParser = new InitializeToyRobotPosition();
            string[] rawInput = "PLACE 2,4,OneDirection".Split(' ');

            // act and assert
            var exception = Assert.Throws<ArgumentException>(delegate { paramParser.InitializeToyRobot(rawInput); });
