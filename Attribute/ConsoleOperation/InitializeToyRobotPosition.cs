...
namespace Attribute.ConsoleOperation
{
    ...
    public class InitializeToyRobotPosition
    {
        ...
        public ToyRobotPlacementAttribute InitializeToyRobot(string[] input)
        {
            Direction direction;
            ...
            return new ToyRobotPlacementAttribute(position, direction);
        }
    }
}
